...
int* ImagePPM::FindHorizontalSeam(int**& calculated_arr)
...
int ImagePPM::FindNextRow1(int current_row,
                           int col,
...
int ImagePPM::FindNextRow2(int current_row,
                           int col,
                           int**& calculated_arr) const {
  int top = calculated_arr[current_row + 1][col];
  int middle = calculated_arr[current_row][col];
...
int ImagePPM::FindNextRow3(int current_row,
                           int col,
                           int**& calculated_arr) const {
  int middle = calculated_arr[current_row][col];
  int bottom = calculated_arr[current_row - 1][col];
...
int* ImagePPM::FindVerticalSeam(int**& calculated_arr)
    const {  // remember to delete in free stack later after use
  // find starting row
...
int ImagePPM::FindNextCol1(int row,
                           int current_col,
                           int**& calculated_arr) const {
...
int ImagePPM::FindNextCol2(int row,
                           int current_col,
                           int**& calculated_arr) const {
  int middle = calculated_arr[row][current_col];
  int right = calculated_arr[row][current_col + 1];
...
int ImagePPM::FindNextCol3(int row,
                           int current_col,
                           int**& calculated_arr) const {
  int left = calculated_arr[row][current_col - 1];
  int middle = calculated_arr[row][current_col];
