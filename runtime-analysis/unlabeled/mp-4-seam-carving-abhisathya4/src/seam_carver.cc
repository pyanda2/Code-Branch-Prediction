...
int* SeamCarver::FindHorizontalSeam(int**& calculated_arr)
    const {  // remember to delete in free stack later after use
  // find starting col
...
int SeamCarver::FindNextRow1(int current_row,
                             int col,
...
int SeamCarver::FindNextRow2(int current_row,
                             int col,
                             int**& calculated_arr) const {
  int top = calculated_arr[current_row + 1][col];
  int middle = calculated_arr[current_row][col];
...
int SeamCarver::FindNextRow3(int current_row,
                             int col,
                             int**& calculated_arr) const {
  int middle = calculated_arr[current_row][col];
  int bottom = calculated_arr[current_row - 1][col];
...
int* SeamCarver::FindVerticalSeam(int**& calculated_arr)
    const {  // remember to delete in free stack later after use
  // find starting row
...
int SeamCarver::FindNextCol1(int row,
                             int current_col,
                             int**& calculated_arr) const {
...
int SeamCarver::FindNextCol2(int row,
                             int current_col,
                             int**& calculated_arr) const {
  int middle = calculated_arr[row][current_col];
  int right = calculated_arr[row][current_col + 1];
...
int SeamCarver::FindNextCol3(int row,
                             int current_col,
                             int**& calculated_arr) const {
  int left = calculated_arr[row][current_col - 1];
  int middle = calculated_arr[row][current_col];
